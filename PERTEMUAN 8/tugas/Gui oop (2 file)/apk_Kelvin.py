...
class FrmKelvin:
    ...
    def aturKomponen(self):
        ...
        Label(self.parent, text='Daffa Ramadani Putra 220511150').pack()
        ...
        Label(mainFrame, text="Fahrenheit:").grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Rearmur").grid(row=6, column=0,
            sticky=W, padx=5, pady=5)
        ...
        self.txtRearmur = Entry(mainFrame) 
        self.txtRearmur.grid(row=6, column=1, padx=5, pady=5) 
    ...
    def onHitung(self):
        ...
        # Suhu dalam Kelvin
        R = K.get_reamur()
        self.txtRearmur.delete(0, END)
        self.txtRearmur.insert(END, str(R))
